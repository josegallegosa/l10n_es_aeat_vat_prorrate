...
* Go to Settings > Technical > Date ranges > Date Range Types where
  ...
  .. figure:: https://raw.githubusercontent.com/OCA/server-tools/16.0/date_range/static/description/date_range_type_create.png
     :scale: 80 %
...
* Go to Settings > Technical > Date ranges >  Date Ranges where
  ...
  .. figure:: https://raw.githubusercontent.com/OCA/server-tools/16.0/date_range/static/description/date_range_create.png
     :scale: 80 %
     :alt: Date range creation

  It's also possible to launch a wizard from the 'Generate Date Ranges' menu.

  .. figure:: https://raw.githubusercontent.com/OCA/server-tools/16.0/date_range/static/description/date_range_wizard.png
     :scale: 80 %
  ...
  .. figure:: https://raw.githubusercontent.com/OCA/server-tools/16.0/date_range/static/description/date_range_wizard_result.png
     :scale: 80 %
...
* Your date ranges are now available in the search filter for any date or datetime fields
  ...
  .. figure:: https://raw.githubusercontent.com/OCA/server-tools/16.0/date_range/static/description/date_range_type_as_filter.png
     :scale: 80 %
  ...
  .. figure:: https://raw.githubusercontent.com/OCA/server-tools/16.0/date_range/static/description/date_range_as_filter.png
     :scale: 80 %
     :alt: Date range as filter value

  And the dates specified into the date range are used to filter your result.

  .. figure:: https://raw.githubusercontent.com/OCA/server-tools/16.0/date_range/static/description/date_range_as_filter_result.png
     :scale: 80 %
...
* You can configure date range types with default values for the generation wizard on the `Generation` tab.
  ...
  .. figure:: https://raw.githubusercontent.com/OCA/server-tools/16.0/date_range/static/description/date_range_type_autogeneration.png
     :scale: 80 %
